...
//        print("New Food Option count: " ,  self.foodOptions[cell.outterTableIndex].options.count)
        self.demandsTableView.reloadData()
...
//    var foodOptions = [FoodOptions]()
    ...
    @IBOutlet weak var scopesTableView: UITableView!{
        didSet {
            self.scopesTableView.dataSource = self
            self.scopesTableView.delegate = self
        }
    }
    @IBOutlet weak var optsTableView: UITableView!{
        didSet {
            self.optsTableView.dataSource = self
            self.optsTableView.delegate = self
        }
    }
    
    @IBOutlet weak var demandsTableView: UITableView! {
        didSet {
            self.demandsTableView.dataSource = self
            self.demandsTableView.delegate = self
        }
    }
...
//        scopesTableView.borderColor = UIColor.gray
//        optsTableView.borderWidth = 1
//        setupTypesData()
...
//        optsTableView.borderColor = UIColor.gray
//        optsTableView.borderWidth = 0.5
//        setupExtrasData()
//        optsTableView.reloadData()
//        recalculateExtraTableHeight()
        //----------------------------------------------------------------------------------
        
//        demandsTableView.dataSource = self
//        scopesTableView.delegate = self
//        setupOptionsData()
...
extension FoodDetailVC : UITableViewDelegate ,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if tableView == scopesTableView{
//            return foodTypes.count
            return self.food.food_data.scopes.count
        }else if tableView == optsTableView{
//            return foodExtras.count
            return self.food.food_data.opts.count
        }else if tableView == demandsTableView{
//            return foodOptions.count
            return self.food.food_data.demands.count
        }else{
            return 0
        }
    }
